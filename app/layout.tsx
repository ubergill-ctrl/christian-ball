...
export const metadata: Metadata = {
  title: "Saint Gabriel's Orthodox Youth Ceilidh Ball 2026",
  description:
  ...
  keywords: ['Orthodox ceilidh ball', 'Orthodox youth', 'Wirral', 'Port Sunlight', 'Hulme Hall', 'ceilidh ball', 'November 2026'],
  openGraph: {
    title: "Saint Gabriel's Orthodox Youth Ceilidh Ball 2026",
    description:
